...
abstract public class TelegramBot {
    ...
    /**
     * This constructor takes the token generated by @BotFather as a String argument.
     *
     ...
     * Then, it calls {@link TelegramBot#shouldSendAsync()}. If this method returns true, it instantiates an asynchronous version
    ...
    /**
     * Returns whether the bot should asynchronously send requests.
     *
     * By default, this method returns true. It can be overridden adjust this behaviour.
     * @return true if this bot should use async requests, false otherwise.
     */
